...
class BinanceFuturesClient:
    ...
    def _make_request(self, method: str, endpoint: str, data: typing.Dict):
        if method == "GET":
            try:
                ...
                logger.error("Connection error while making a %s request to %s: %s", method, endpoint, e)
                return None
    ...
    def subscribe_channel(self, contracts: typing.List[Contract], channel: str, reconnection=False):
        ...
        try:
            ...
            logger.error("Websocket error while subscribing to %s %s updates: %s", 3, channel, e)
